...
#if defined(__IPHONE_OS_VERSION_MIN_REQUIRED) && __IPHONE_OS_VERSION_MIN_REQUIRED >= 190000 \
    || defined(__MAC_OS_X_VERSION_MIN_REQUIRED) && __MAC_OS_X_VERSION_MIN_REQUIRED >= 160000 \
    || defined(__TV_OS_VERSION_MIN_REQUIRED) && __TV_OS_VERSION_MIN_REQUIRED >= 190000 \
    || defined(__WATCH_OS_VERSION_MIN_REQUIRED) && __WATCH_OS_VERSION_MIN_REQUIRED >= 120000
#define LIBXML_API_AVAILABLE_MACOS16_IOS19_WATCHOS12_TVOS19 \
        __IOS_AVAILABLE(19.0) __OSX_AVAILABLE(16.0) __TVOS_AVAILABLE(19.0) __WATCHOS_AVAILABLE(12.0)
#else
#define LIBXML_API_AVAILABLE_MACOS16_IOS19_WATCHOS12_TVOS19
#endif
